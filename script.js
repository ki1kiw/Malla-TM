...
const cursos = [
  ...
  { id: "morfo2", nombre: "Morfofunción II", semestre: 2, abre: ["fisiopato"], req: ["morfo1", "biocel"] },
  { id: "quimica", nombre: "Química General y Orgánica", semestre: 2, abre: ["fisiopato", "bioquimica"], req: ["mate"] },
  { id: "ingles1", nombre: "Inglés I", semestre: 2, abre: ["ingles2"] },
  { id: "cfg1", nombre: "CFG 1", semestre: 2 },
  { id: "cfg2", nombre: "CFG 2", semestre: 2 },
  { id: "fisiopato", nombre: "Fisiopatología y Farmacología", semestre: 3, abre: ["inmunobasica", "bioseguridad"], req: ["morfo2", "quimica"] },
  { id: "bioquimica", nombre: "Bioquímica", semestre: 3, abre: ["bioseguridad"], req: ["quimica"] },
  { id: "ingles2", nombre: "Inglés II", semestre: 3, abre: ["ingles3"], req: ["ingles1"] },
  { id: "cfg3", nombre: "CFG 3", semestre: 3 },
  { id: "cfg4", nombre: "CFG 4", semestre: 3 },
  { id: "inmunobasica", nombre: "Inmunología Básica", semestre: 4, abre: ["bioqclinica1"], req: ["fisiopato"] },
  { id: "bioseguridad", nombre: "Bioseguridad y Enfermería", semestre: 4, abre: ["hematoclinica1", "bioqclinica1", "saludpublica"], req: ["fisiopato", "bioquimica"] },
  ...
  { id: "hematoclinica1", nombre: "Hematología Clínica I", semestre: 5, abre: ["hematoclinica2"], req: ["bioseguridad", "labclinico"] },
  { id: "bioqclinica1", nombre: "Bioquímica Clínica I", semestre: 5, abre: ["bioqclinica2", "inmunoclinica"], req: ["bioseguridad", "labclinico", "inmunobasica"] },
  { id: "biomolaplicada", nombre: "Biología Molecular Aplicada", semestre: 5, abre: ["micro"], req: ["biomol"] },
  { id: "saludpublica", nombre: "Salud Pública y Epidemiología", semestre: 5, abre: ["gestion"], req: ["bioseguridad"] },
  { id: "hematoclinica2", nombre: "Hematología Clínica II", semestre: 6, abre: ["inmunohema", "hematoclinica3"], req: ["hematoclinica1"] },
  { id: "bioqclinica2", nombre: "Bioquímica Clínica II", semestre: 6, abre: ["micro"], req: ["bioqclinica1"] },
  { id: "inmunoclinica", nombre: "Inmunología Clínica", semestre: 6, abre: ["inmunohema"], req: ["bioqclinica1"] },
  { id: "gestion", nombre: "Administración y Gestión en Salud", semestre: 6, abre: ["calidad"], req: ["saludpublica"] },
  { id: "cfg6", nombre: "CFG 6", semestre: 6 },
  { id: "micro", nombre: "Microbiología Clínica", semestre: 7, abre: ["diagnostico"], req: ["biomolaplicada", "bioqclinica2"] },
  { id: "inmunohema", nombre: "Inmunohematología", semestre: 7, abre: ["transfusional"], req: ["inmunoclinica", "hematoclinica2"] },
  { id: "hematoclinica3", nombre: "Hematología Clínica III", semestre: 7, req: ["hematoclinica2"] },
  { id: "calidad", nombre: "Gestión de Calidad", semestre: 7, abre: ["gestioninvestigacion"], req: ["gestion"] },
  ...
  { id: "gestioninvestigacion", nombre: "Gestión e Investigación en Salud", semestre: 8, abre: ["gestionprimaria"], req: ["calidad"] },
